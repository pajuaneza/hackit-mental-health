    ...
    <body>
        ...
        <main class="main-content" id="about">
            <section class="main-content__section">
                ...
                <p>Meditation allows you to reduce stress and control your anxiety by putting yourself in the present moment. If you want to learn how to meditate, you can check out this <a target="_blank" href="https://youtu.be/mMMerxh_12U" class="text-link"><i class="fa fa-film"></i> beginner's guide to meditation</a> by Improvement Pill on YouTube. We've also got some relaxing music on the <a href="./audiovisual.php" class="text-link"><i class="fa fa-file-audio"></i> Videos and Music</a> page.

                <h2 class="text-h3">Spend Time With Your Pet</h2>
                <p>Your dog or cat (or some other lovable creature) may be fluffy, funny, and all around derpy, but pets have been proven to keep your mind sharp and provide companionship. There are lots of <a target="_blank" href="https://thebark.com/content/9-ways-improve-your-relationship-your-dog" class="text-link"><i class="fa fa-link"></i> ways to bond and spend time with your pet</a>, so don't be shy!</p>
                ...
                <p>Your house will not only smell great, but studies have shown that <a target="_blank" href="https://shopessentialseveryday.com/" class="text-link"><i class="fa fa-link"></i> aromatherapy</a> might have health benefits, including:
